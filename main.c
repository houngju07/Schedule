...
int main(int argc, char *argv[]) {
	...
	while (list!=EOF /* fill code here -- read from the file*/ )
	{	
	...
	while(exit_flag == 0) 
	{
		//3. menu printing
		//fill code here ---- 
		printf("1. printing all the schedules in the scheduler\n");
		...
		switch(option)
		{
			...
			case 4:
				...
				if ((sched_convertType(typeName)==0)/* fill code here -- convert the type and check if the type is valid */)
				{
					ndPtr = list;
					while (list_isEndNode(ndPtr) == 0)
					{
